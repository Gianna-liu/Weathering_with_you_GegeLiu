...
with col1:
    ...
    # define a radio 
    price_area = st.radio(label = "Step1: Select Price Area", options = sorted(df['pricearea'].unique())) # get the option from input and sort order
